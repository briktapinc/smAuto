#!/bin/bash
# Launch Bubble Pod on macOS (same role as "Launch Bubble Pod.bat" on Windows).
cd "$(dirname "$0")" || exit 1
...
open_app "./dist/mac/Bubble Pod.app"
open_app "./dist/mac-arm64/Bubble Pod.app"
open_app "./dist/mac-universal/Bubble Pod.app"
...
if command -v npm >/dev/null 2>&1; then
  echo "Starting Bubble Pod via npm start…"
  exec npm start
fi
